    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        ...
        switch (typeEnum) {
            ...
            case TOOL_EXECUTED -> {
                ...
                String relativeFilePath = jsonObject.getStr("relativeFilePath");//路径
                String suffix = FileUtil.getSuffix(relativeFilePath);//后缀
                String content = jsonObject.getStr("content");//内容
