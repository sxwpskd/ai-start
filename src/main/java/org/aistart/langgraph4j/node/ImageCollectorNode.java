...
import org.aistart.langgraph4j.langai.ImageCollectionPlanService;
import org.aistart.langgraph4j.langai.ImageCollectionService;
...
import org.aistart.langgraph4j.model.langenums.ImageCategoryEnum;
...
/**
 * 图片收集节点
 * 使用AI进行工具调用，收集不同类型的图片-completableFuture实现
 */
@Slf4j
